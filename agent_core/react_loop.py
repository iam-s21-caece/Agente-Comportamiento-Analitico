...
class ReactLoop:
    ...
    def __init__(
        ...
        # Consumo de tokens acumulado del análisis en curso (todas las iteraciones).
        self._usage = Usage()

    @property
    def last_usage(self) -> Usage:
        """Consumo de tokens del último análisis ejecutado (para estampar la alerta)."""
        return self._usage
    ...
    def run(self, state_summary: str) -> Alert:
        ...
        self._usage = Usage()  # reinicia el acumulador para este análisis
        ...
        for iteration in range(1, self.settings.react_max_iterations + 1):
            ...
            self._usage = self._usage + response.usage  # acumula tokens del turno
    ...
    def _record_end(self, alert: Alert, iterations: int) -> None:
        ...
        self.recorder.end_analysis(self._analysis_id, iterations, usage=self._usage)
